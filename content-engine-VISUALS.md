...
> **Archetype lock.** No archetype twice in a row, and no archetype more than twice in any trailing 5 shipped visual pieces. Where fewer than 6 archetypes are built, the second clause is suspended and only the no-repeat-in-a-row clause applies. Carousels do not count as shipped visual pieces for this lock, because they carry no `archetype:`.
